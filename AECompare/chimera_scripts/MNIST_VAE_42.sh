...
for i in 30 35 40
do
    python train.py --model 'VAE' --latent_len $i --random_seed 123 
    python train.py --model 'VAE' --latent_len $i --random_seed 123 --epochs 50
    python train.py --model 'VAE' --latent_len $i --random_seed 123 --learning_rate 0.0001
    python train.py --model 'VAE' --latent_len $i --random_seed 123 --learning_rate 0.0001 --epochs 50
done
